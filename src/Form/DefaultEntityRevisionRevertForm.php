...
class DefaultEntityRevisionRevertForm extends ConfirmFormBase {
   ...
   * The News revision.
   *
   * @var \Drupal\entity_email\Entity\DefaultEntityInterface
   */
  protected $revision;
   ...
   *
   * @param \Drupal\entity_email\Entity\DefaultEntityInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\entity_email\Entity\DefaultEntityInterface
